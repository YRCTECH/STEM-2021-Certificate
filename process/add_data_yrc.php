<?php
    ...
    if(isset($_POST['insert'])){
        ...
        $sql = "INSERT INTO `yrc_certificate` (`c_id`, `c_ref_code`, `c_type`, `c_grade`, `c_team`, `c_subject`,`c_name`, `c_awards`, `c_status`) 
        VALUES (NULL, '$c_ref_code', 'การประกวดโครงงานวิทยาศาสตร์ (Student Science Project Contest)', 'มัธยมศึกษาตอนปลาย', '$c_team', '$c_subject', '$c_name', '$c_awards', '$c_status');";
