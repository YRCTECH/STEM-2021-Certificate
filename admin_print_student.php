                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <a href="admin_print_student.php" class="btn btn-primary w-100 mt-3"style="font-weight: 600;">เพิ่มข้อมูล</a>
                                        <?php }else{ ?>
                                        <h4 class="text-primary" style="font-weight: 600;">เพิ่มข้อมูล</h4>
                                        <hr>
                                        <div id="link_wrapper"></div>
                                        <form class="form-material mt-4" action="process/add_data_student.php" method="post">
                                            <div class="form-group">
                                                <label for="">เลขที่เกียรติบัตร</label>
                                                <input type="text" class="form-control form-control-line" name="c_ref_code">
                                            </div>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="table-responsive">
                                            <table id="lang_opt" class="table table-bordered table-hover mt-3">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM student_certificate ORDER BY c_id ASC";
                                                        $query = mysqli_query($conn,$sql);
                                                        $i = 1;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 15%;"><?php echo $fetch['c_awards']?></td>
                                                        <td><?php echo $fetch['c_name']?><br />โรงเรียน<?php echo $fetch['c_school']?>
                                                        </td>
                                                        <td style="width: 10%;"><a href="admin_print_student.php?id=<?php echo $fetch['c_id']; ?>"
                                                                class="btn btn-warning">แก้ไข</a></td>
                                                        <td style="width: 10%;"><a href="process/delete_data_student.php?id=<?php echo $fetch['c_id']; ?>"
