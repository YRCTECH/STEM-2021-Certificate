                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-bordered table-hover mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td class="text-center" style="width: 10%;" class="text-center"><?php echo $i++ ?></td>
                                                <td><?php echo $fetch['c_name']?></td>
                                                <td><?php echo $fetch['c_awards']?></td>
                                                <td class="text-center" style="width: 10%;" class="text-center"><a href="certi_teacher.php?id=<?php echo $fetch['c_id']; ?>"><i class='fas fa-download'></i></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
