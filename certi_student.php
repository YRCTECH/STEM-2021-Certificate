...
if (isset($_GET['id'])) {
    ...
    if ($id == '') {
        ...
        $sql = "SELECT * FROM student_certificate WHERE c_id = '$id'";
        ...
        if ($num > 0) {
            if ($fetch['c_awards'] == 'เข้าร่วม') {
                ...
                $pdf->SetXY(210, 310);
                $pdf->SetTextColor(33, 60, 130);
                $pdf->Cell(0, 15, iconv('utf-8', 'cp874', 'ได้' . $fetch['c_awards'] . $fetch['c_type']), 0, 1, 'C');
                $pdf->SetXY(210, 340);
            ...
            if($fetch['c_awards_detail'] == 'เข้าร่วม'){
                ...
                $pdf->SetXY(210, 305);
                $pdf->SetTextColor(33, 60, 130);
                $pdf->Cell(0, 15, iconv('utf-8', 'cp874', 'ได้รับรางวัล' .  ' ระดับ' . $fetch['c_awards']), 0, 1, 'C');
                $pdf->SetXY(210, 330);
