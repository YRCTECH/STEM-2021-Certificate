                                    ...
                                    <table id="lang_opt" class="table table-bordered table-hover mt-3">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-weight: 600;">ชื่อ-สกุล/สถานะ</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['c_name']?><br />สถานะ : <?php echo $fetch['c_status']?></td>
                                                <td style="width: 10%;"><a href="certi_yrc.php?id=<?php echo $fetch['c_id']; ?>"><i class='fas fa-download'></i></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
